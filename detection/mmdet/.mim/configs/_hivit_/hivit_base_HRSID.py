...
data_root = '/home/vgc/users/lwj/detection_hivit/detection/data/HRSID/'
...
optimizer = dict(
    ...
    paramwise_cfg=dict(num_layers=20, layer_decay_rate=0.95),
)

lr_config = dict(step=[27*2, 33*2])
runner = dict(type='EpochBasedRunner', max_epochs=36*2)
...
evaluation = dict(interval=8, metric='bbox', save_best='auto')